...
def csv2distances(fname, new=False):
    ...
    with open(fname) as csvfile:
        ...
        for line in csvreader:
            ...
            ication_label = get_position_in_list(header, ['lab1', 'atomname_cation'])
            ...
            ianion_lbl = get_position_in_list(header, ['lab2', 'atomname_anion'])
            anion_lbl = line[ianion_lbl].strip()
            idistance = get_position_in_list(header, ['dist1', 'distance'])
...
if __name__ == "__main__":
    ...
    dists_all = csv2distances("bvparam2015_noc_%s.csv" % cation_lbl)
